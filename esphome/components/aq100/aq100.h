...
/*
 AQ100 Custom Sensor Component
 
 Based on the following sensors

 SHT41 - Temp and humidity
 SGP40 - Air quality
*/
...
enum SHT4XHEATERPOWER { SHT4X_HEATERPOWER_HIGH = 0, SHT4X_HEATERPOWER_MED, SHT4X_HEATERPOWER_LOW };
...
class AQ100Component : public PollingComponent, public uart::UARTDevice {
 public:
  ...
  void set_temperature_sensor(sensor::Sensor *temp_sensor) { this->temp_sensor_ = temp_sensor; }
